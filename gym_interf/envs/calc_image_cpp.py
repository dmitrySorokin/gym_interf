...
libc.calc_image.argtypes = [
    ...
    POINTER(c_double), POINTER(c_double), c_double, POINTER(c_double), c_double, c_int, c_double, c_double,
    POINTER(c_double), POINTER(c_double), c_double, POINTER(c_double), c_double, c_int, c_double, c_double,
...
def calc_image(
        start, end, n_points,
        wave_vector1, center1, radius1, beam1_mask, length1, n_pixels1, sigma1x, sigma1y,
        wave_vector2, center2, radius2, beam2_mask, length2, n_pixels2, sigma2x, sigma2y,
    ...
    libc.calc_image(
        start, end, n_points,
        to_double_pointer(wave_vector1), to_double_pointer(center1), radius1, beam1_mask, length1, n_pixels1, sigma1x, sigma1y,
        to_double_pointer(wave_vector2), to_double_pointer(center2), radius2, beam2_mask, length2, n_pixels2, sigma2x, sigma2y,
