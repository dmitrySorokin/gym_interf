...
libc.calc_image.argtypes = [
    ...
    POINTER(c_double), POINTER(c_double), c_double, POINTER(c_double), c_double, c_int, c_double, c_double, c_double, c_double,
    c_double, c_double, c_int, c_int, c_double, c_double, c_bool, c_double,
...
def calc_image(
        ...
        r_curvature1, r_curvature2, n_forward_frames, n_backward_frames, lamb, omega, has_interf,
    ...
    libc.calc_image(
        ...
        r_curvature1, r_curvature2, n_forward_frames, n_backward_frames, lamb, omega, has_interf, noise_coef,
