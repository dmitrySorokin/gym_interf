...
libc.calc_image.argtypes = [
    ...
    POINTER(c_double), POINTER(c_double), c_double, POINTER(c_double), c_double, c_int, c_double, c_double, c_double, c_double,
    c_double, c_int, c_int, c_double, c_double, c_bool, c_double, c_double,
...
def calc_image(
        ...
        noise_coef, piezo_std, use_beam_masks, n_threads=8):
    ...
    libc.calc_image(
        ...
        r_curvature, n_forward_frames, n_backward_frames, lamb, omega, has_interf, noise_coef, piezo_std,
