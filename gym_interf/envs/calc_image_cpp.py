...
def calc_image(
        ...
        wave_vector1, center1, radius1, beam1_mask, length1, n_pixels1, sigma1x, sigma1y, beam1_ampl, beam1_rotation, r_curvature1,
        wave_vector2, center2, radius2, beam2_mask, length2, n_pixels2, sigma2x, sigma2y, beam2_ampl, beam2_rotation,
        r_curvature2, n_forward_frames, n_backward_frames, lamb, omega, has_interf,
    ...
    libc.calc_image(
        ...
        r_curvature2, n_forward_frames, n_backward_frames, lamb, omega, has_interf, noise_coef,
